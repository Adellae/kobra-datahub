...
def transform_dw_fakt_brankari(connection: sqlite3.Connection) -> None:
    # 1. Načtení zdrojových a dimenzních tabulek
    df_raw = pd.read_sql("SELECT * FROM raw_match_goalies", connection)
    ...
    # Napojení na zápas (přes zapas_id)
